    ...
    public partial class ModelsForm : Form
    {
        ...
        private void Panel1_Paint(object sender, PaintEventArgs e)
        {
            if(!SB1.Visible)
            {
                ...
                models[0].DrawUnit.DrawFrame(b, models[0].Cars, models[0].Ppl, crashServices[0], models[0].CurLight);
        ...
        private void Panel2_Paint(object sender, PaintEventArgs e)
        {
            if (!SB2.Visible)
            {
                ...
                models[1].DrawUnit.DrawFrame(b, models[1].Cars, models[1].Ppl, crashServices[0], models[1].CurLight);
                e.Graphics.DrawImage(b, 0, 0);
                b.Dispose();
            }
        ...
        private void Panel3_Paint(object sender, PaintEventArgs e)
        {
            if (!SB3.Visible)
            {
                ...
                models[2].DrawUnit.DrawFrame(b, models[2].Cars, models[2].Ppl, crashServices[0], models[2].CurLight);
                e.Graphics.DrawImage(b, 0, 0);
                b.Dispose();
            }
        ...
        private void Panel4_Paint(object sender, PaintEventArgs e)
        {
            if (!SB4.Visible)
            {
                ...
                models[3].DrawUnit.DrawFrame(b, models[3].Cars, models[3].Ppl, crashServices[0], models[3].CurLight);
                e.Graphics.DrawImage(b, 0, 0);
                b.Dispose();
            }
